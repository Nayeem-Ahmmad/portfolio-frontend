...
export default function Contact() {
  return (
    <div className="bg-panel/60 backdrop-blur-sm rounded-2xl px-8 py-8 max-w-lg w-full">
      ...
      <div className="flex items-center gap-5 mb-8">
        <a
          href={`mailto:${EMAIL}`}
          aria-label="Email"
          className="flex items-center gap-2 text-fog hover:text-moss transition-colors text-sm"
        >
